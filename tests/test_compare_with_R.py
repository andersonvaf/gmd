...
class TestGMD(unittest.TestCase):
    ...
    def test_create_sorted(self):
        ...
        greedy = gmd.GMD(random_state=1234)
        greedy.fit(unsorted)
    ...
    def test_compare_kstest_with_slice_from_R(self):
        ...
        greedy = gmd.GMD(random_state=1234).fit(data)
    ...
    def test_avg_deviation_statistics(self):
        ...
        data = pd.read_csv('tests/res/spambase_small.data', index_col=None, header=None).values
        print(data)
        greedy = gmd.GMD(runs=1000, random_state=1234).fit(data)
    ...
    def test_gmd_1(self):
        ...
        greedy = gmd.GMD(alpha=.1, runs=1000, random_state=1234)
        greedy.fit(data)  
